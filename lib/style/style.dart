...
const LinearGradient brandGradient =
...
const LinearGradient horizontalGradient =
...
ButtonStyle contactActionStyle = ButtonStyle(
    padding: MaterialStateProperty.all(
        const EdgeInsets.symmetric(horizontal: 24, vertical: 12)),
    backgroundColor: MaterialStateProperty.all(const Color(0xFFF2F6FF)),
    overlayColor: MaterialStateProperty.all(const Color(0xFFE0EAFF)),
